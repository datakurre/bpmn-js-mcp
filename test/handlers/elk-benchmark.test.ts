...
describe('ELK benchmark: parallel joins', () => {
  ...
  it('nested parallel gateways: zero crossing flows', async () => {
  ...
  it('asymmetric parallel join: one branch has more tasks', async () => {
  ...
  it('wide diamond: 8 parallel branches with zero crossings', async () => {
...
describe('ELK benchmark: boundary events', () => {
  ...
  it('error boundary with recovery path: orthogonal routing', async () => {
  ...
  it('multiple boundary events on same task: no element overlap', async () => {
    ...
    await handleConnect({ diagramId, sourceElementId: timerBound, targetElementId: timerHandler });
  ...
  it('boundary event with loop-back: no crossing flows', async () => {
...
describe('ELK benchmark: large collaborations', () => {
  ...
  it('three-pool collaboration with message flows', async () => {
  ...
  it('collaboration with 10+ tasks per pool', async () => {
...
describe('ELK benchmark: happy path preservation', () => {
  ...
  it('happy path elements stay on same row with preserveHappyPath', async () => {
  ...
  it('preserveHappyPath: false allows free arrangement', async () => {
